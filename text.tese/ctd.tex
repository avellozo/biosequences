...
execução do Algoritmo~\ref{alg:invgeral}. A linha pontilhada representa um
alinhamento ótimo com \invnsobs\ de ${s[1\Rng i]} \times t[1\Rng j]$ e a linha
tracejada o alinhamento de $\overline{s[i'+1\Rng i]} \times t[j'+1\Rng j]$}.
\label{fig:algn3logn}
\end{figure}
...
modelo que propomos e que estamos implementando e preparando para publicação, é
...
tratar muito mais casos que o do Benson.
