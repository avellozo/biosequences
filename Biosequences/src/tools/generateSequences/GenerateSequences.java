...
public class GenerateSequences
{
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			egInverted = new ArcDiagonalFactorySequences(new ComplementReverseSequence(seq1), seq2, 1, -1, -2,
				optimumPathDummyFactory, null);
			eg = new ArcDiagonalFactorySequences(seq1, seq2, 1, -1, -2, pathBimDummyFactory, new ExtenderUsingEGInvertedRows(
				egInverted, 2));
