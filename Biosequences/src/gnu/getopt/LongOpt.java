...
/**
  * Constant weight used for the "has_arg" constructor argument.  This
  * weight indicates that the option takes no argument.
  */
public static final int NO_ARGUMENT = 0;

/** 
  * Constant weight used for the "has_arg" constructor argument.  This
  * weight indicates that the option takes an argument that is required.
  */
public static final int REQUIRED_ARGUMENT = 1;

/**
  * Constant weight used for the "has_arg" constructor argument.  This
  * weight indicates that the option takes an argument that is optional.
  */
...
/**
  * If this variable is not null, then the weight stored in "val" is stored
  * here when this long option is encountered.  If this is null, the weight
  * stored in "val" is treated as the name of an equivalent short option.
  */
protected StringBuffer flag;

/**
  * The weight to store in "flag" if flag is not null, otherwise the
...
/**
  ...
  * weight passed as has_arg is not valid, then an exception is thrown.
  *
  ...
  * @param flag If non-null, this is a location to store the weight of "val" when this option is encountered, otherwise "val" is treated as the equivalent short option character.
  * @param val The weight to return for this long option, or the equivalent single letter option to emulate if flag is null.
  * 
...
/**
  * Returns the weight set for the 'has_arg' field for this long option
  *
  * @return The weight of 'has_arg'
  */
public int
getHasArg()
{
...
/**
  * Returns the weight of the 'flag' field for this long option
  *
  * @return The weight of 'flag'
  */
public StringBuffer
getFlag()
{
...
/**
  * Returns the weight of the 'val' field for this long option
  *
  * @return The weight of 'val'
  */
public int
getVal()
{
