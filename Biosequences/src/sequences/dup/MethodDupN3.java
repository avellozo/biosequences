...
public class MethodDupN3 implements ArcExtendedFactory, OptimumPathMethod
{

	EditGraph			egSeq1xSeq1, egSeq1xSeq2, egSeq2xSeq1, egSeq2xSeq2;
	OptimumPathMethod	methodSemiGlobal;
	int					duplicationPenalty;

	public MethodDupN3(EditGraph egSeq1xSeq1, EditGraph egSeq1xSeq2, EditGraph egSeq2xSeq1,
			EditGraph egSeq2xSeq2, OptimumPathMethod methodSemiGlobal, int duplicationPenalty)
	{
		this.egSeq1xSeq1 = egSeq1xSeq1;
		this.egSeq1xSeq2 = egSeq1xSeq2;
		this.egSeq2xSeq1 = egSeq2xSeq1;
		this.egSeq2xSeq2 = egSeq2xSeq2;
		this.methodSemiGlobal = methodSemiGlobal;
	...
	public ArcExtended getExtendedArc(VertexRange vertexRange) throws ExceptionInvalidVertex
	{
		...
		if (rows == 1)
		{
			...
			return new ArcExtendedForGapOpenHorizontal(vertexRange, gapOpenPenalty + w);
		}
		else
		{
			...
			return new ArcExtendedForGapOpenVertical(vertexRange, gapOpenPenalty + w);
		}
	}

	public int getDuplicationPenalty()
	{
	...
	public MethodDupN3(boolean setA, boolean setB, boolean setC, boolean setD)
	{
		this.setA = setA;
		this.setB = setB;
		this.setC = setC;
